...
QVector<QString> MockData::nicknames{"开心的火龙果", "二爷",      "你仔细听", "小乖乖",         "忆生i",
                                     "杨酷酷",       "五行缺钱",  "MRBEE",    "星川",           "怀念",
                                     "没毛的小狐狸", "八尺妖剑",  "提露",     "一个超人的角色", "所念皆星河",
                                     "远辰",         "Cold moon", "永恒",     "ZVerify",        "明天一定吃早饭"};

QVector<QString> MockData::statuses{"忙碌", "在线", "离开", "求锦鲤", "发呆", "胡思乱想"};

QVector<QString> MockData::feelings = {"每一天都是一个新的开始。", "梦想，永不放弃。",
                                       "阳光总在风雨后。",         "不忘初心，方得始终。",
